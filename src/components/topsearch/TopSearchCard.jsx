...
const TopSearchCard = ({ routeFrom, routeTo, timeDuration, price }) => {
  return (
    <div className="w-full rounded-xl p-5 border-2 border-neutral-300 space-y-10">
      <div className="space-y-3.5 w-full">
        ...
        <div className="space-y-0">
          ...
          <div className="w-full flex items-center justify-between gap-x-3">
            ...
            {/* Time Duration */}
            {/* <div className="flex-1 border border-dashed border-neutral-400 relative">
            ...
            <div className="flex-1 border border-dashed border-neutral-400 relative">
              <p className="absolute px-3 py-1 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-neutral-50 rounded-full flex items-center justify-center text-sm text-neutral-500 font-normal border-dashed border border-neutral-400 whitespace-nowrap">
                {timeDuration}
              </p>
            </div>
      ...
      <div className="w-full flex items-center justify-between">
        {/* price */}
        <h1 className="text-xl text-neutral-700 font-semibold">Rp. {price}</h1>
